...
### Key 6: Voice Input (🎤︎)
**Shortcut:** `Cmd + D` (macOS) or custom
...
- **[Download Config (.sayobak)](../presets/claude_code.sayobak)** — Import directly to SayoDevice
- **[Print Icons (HTML)](../presets/icons-claude-code.html)** — 12×12mm ready to print
